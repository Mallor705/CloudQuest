...
def main():
    ...
    try:
        ...
        # 2. Inicializar a sincronização da nuvem para local
        ...
        if not game_process:
            raise Exception("Processo do jogo não foi iniciado corretamente")
        ...
        # 5. Sincronizar de volta para a nuvem
        ...
        # Uma notificação de erro crítico seria mostrada aqui
        sys.exit(1)
    finally:
